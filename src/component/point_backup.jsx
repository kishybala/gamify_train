...
const StudentDetail = ({ student, onClose, db, adminId, setNotification, students, setStudents }) => {
    ...
    return (
        <div className="bg-white rounded-3xl shadow-2xl border border-gray-200 max-h-[90vh] overflow-hidden flex flex-col">
            {/* Header */}
...
const App = () => {
    ...
    return (
        <div className="min-h-screen font-['Inter'] relative overflow-hidden p-6 sm:p-8 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
                        ...
                        <div className="relative">
                            <div className="flex items-center bg-gradient-to-r from-indigo-50 to-purple-50 p-4 rounded-2xl border border-indigo-200 shadow-lg">
                                <div className="relative mr-4">
                                    <img 
                                        src={localStorage.getItem("profilePic") || "https://ui-avatars.com/api/?name=A&background=666666&color=ffffff&size=50"} 
                                        alt="Admin Profile" 
            ...
            <div className={`relative z-10 transition-all duration-300 ${selectedStudent ? 'opacity-20 pointer-events-none' : 'opacity-100 pointer-events-auto'}`}>
                ...
                <div className={`fixed inset-0 z-[999] flex items-center justify-center p-4 transition-opacity duration-300 ${selectedStudent ? 'opacity-100' : 'opacity-0 pointer-events-none'}`} style={{ backgroundColor: 'rgba(0, 0, 0, 0.7)' }}>
                    <div className={`w-full max-w-2xl max-h-[90vh] transition-all duration-500 ease-out ${selectedStudent ? 'scale-100 opacity-100 translate-y-0' : 'scale-95 opacity-0 translate-y-8'}`}>
                        {selectedStudent && (
                            <StudentDetail
