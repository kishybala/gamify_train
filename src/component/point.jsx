    ...
    if (!isEditMode) {
        return (
            <div className="fixed top-4 right-4 z-30">
                <button
                    onClick={openEditMode}
                    className="bg-gradient-to-r from-violet-500 to-purple-600 text-white px-4 py-2 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center space-x-2"
                >
                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                    </svg>
...
const StudentDetail = ({ student, onClose, db, adminId, setNotification, students, setStudents }) => {
    ...
    return (
        <div className="bg-white rounded-3xl shadow-2xl border border-gray-200 max-h-[85vh] overflow-hidden">
            {/* Header */}
            <div className={`bg-gradient-to-r ${bgGradient} px-6 py-4 border-b border-gray-200`}>
...
const App = () => {
    ...
    return (
        <div className="min-h-screen font-['Inter'] relative overflow-hidden p-6 sm:p-8 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
            ...
            <AdminProfileEdit setNotification={setNotification} />
                        ...
                        <div className="flex items-center space-x-4">
                            <div className="w-16 h-16 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-xl">
                                <svg className="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H9a2 2 0 00-2 2v14zM12 7h.01" />
                                </svg>
                            </div>
                            <div>
                                ...
                                <p className="text-gray-600 font-medium">Track & Reward Student Performance</p>
                            </div>
                        </div>
                        <div className="relative">
                            <div className="flex items-center bg-gradient-to-r from-indigo-50 to-purple-50 p-4 rounded-2xl border border-indigo-200 shadow-lg">
                                <div className="relative mr-4">
                                    <img 
                                        src={localStorage.getItem("profilePic") || "https://via.placeholder.com/50"} 
                                        alt="Admin Profile" 
            ...
            <div className={`relative z-10 transition-all duration-300 ${selectedStudent ? 'opacity-30 pointer-events-none' : 'opacity-100 pointer-events-auto'}`}>
                ...
                <div className={`fixed inset-0 z-50 flex items-center justify-center p-4 transition-opacity duration-300 ${selectedStudent ? 'opacity-100' : 'opacity-0 pointer-events-none'}`} style={{ backgroundColor: 'rgba(0, 0, 0, 0.4)' }}>
                    <div className={`w-full max-w-lg transition-all duration-500 ease-out ${selectedStudent ? 'scale-100 opacity-100 translate-y-0' : 'scale-95 opacity-0 translate-y-8'}`}>
                        {DetailPanel}
                    </div>
                </div>
            </div>
